...
//     //Syntas: datatype[] (nameOfVariable) = new (datatype)[(sizeOfArray)]
...
//     //HashSet Collections
//     //There is no particular order to the elements, it is not a zero-based index(you cant get specific elements or LINQ)
...
//     //Keys need to be unique to be able to locate information
...
//     //Thye are collections that dont need any data type
...
//         //For loop
//         //Sets a variable; some condition to check if it repeats; increment/decrement of a variable
